...
for i = 0
A_x_xz_1 = F_a_12;
B_y_xz = (F_t_12*0.05)/0.2;
A_y_xz = F_t_12-B_y_xz;

A_x_xy_1 = F_a_12
B_y_xy = ((F_r_12*0.05)+(F_a_12*(0.04502)))/0.2;
...
M112XZ = F_t_12 *(x11-0.05) - A_y_xz*(x11);
...
M112XY = A_y_xy*x11 - (F_r_12*(x11-0.05)) + (F_a_12*(0.04502));
end
...
Mx_xy_32 = (F_r_34*(x32-0.15)) - (Ey*x32);
end
